...
public class DataExamples {
	...
	private void initDatabase() {
		...
		prod4 = new Product("Back to the Future",
				...
				"Michael J. Fox, Christopher Lloyd", 1985, "img/Films/BTTF.jpg");
		...
		prod5 = new Product("The shining",
				...
				"Jack Nicholson, Shelley Duvall, Danny Lloyd", 1980, "img/Films/Shining.jpg");
		...
		prod6 = new Product("The proposal",
				...
				"Ryan Reynolds, Sandra Bullock", 2009, "img/Films/TheProposal.jpg");
		...
		prod102 = new Product("Hannibal",
				...
				"Hugh Dancy, Mads Mikkelsen", 2015, "img/Series/Hannibal.jpg");
		...
		prod200 = new Product("The witcher 3: Wild Hunt",
				...
				"Geralt, Ciri, Jenneffer, Triss, Eredin.", 2015, "img/Games/pc-witcher3.jpg");
		...
		prod201 = new Product("Monster Hunter World",
				...
				"Hunters and monsters", 2018, "img/Games/pc-monsterhunter.jpg");
		...
		prod202 = new Product("Mario Kart 8 Deluxe",
				...
				"Mario and Company", 2017, "img/Games/switch-kart8.jpg");
		...
		prod203 = new Product("Uncharted 4: A thief's End",
				...
				"Nathan Drake, Victor Sullivan, Elena", 2017, "img/Games/ps4-uncharted4.jpg");
