...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/home").hasAnyRole("USER");
        ...
        http.authorizeRequests().antMatchers("/api/selectpay").hasAnyRole("USER");
        http.authorizeRequests().antMatchers("/api/admin-userList").hasAnyRole("ADMIN");
        http.authorizeRequests().antMatchers("/api/user-orderlist").hasAnyRole("USER");
        http.authorizeRequests().antMatchers("/api/user-ordertable").hasAnyRole("USER");
        http.authorizeRequests().antMatchers("/api/admin-products").hasAnyRole("ADMIN");
        ...
        http.authorizeRequests().antMatchers("/api/admin-userTable").hasAnyRole("ADMIN");
        
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/api/admin-add-pack-action").hasAnyRole("ADMIN");
        http.authorizeRequests().antMatchers("/api/admin-orderlist").hasAnyRole("ADMIN");
        http.authorizeRequests().antMatchers("/api/admin-packlist").hasAnyRole("ADMIN");
        ...
        http.authorizeRequests().antMatchers("/api/admin-user").hasAnyRole("ADMIN");
        ...
        http.authorizeRequests().antMatchers("/api/admin-user").hasAnyRole("USER");
